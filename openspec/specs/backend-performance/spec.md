...
Requisito não-funcional de que o backend processa requisições HTTP sem bloquear threads da
plataforma enquanto aguarda respostas de I/O externo (DynamoDB, S3, SQS), preservando o mesmo
contrato de API observável.
